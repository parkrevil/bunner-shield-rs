...
- [x] 키 로테이션 경로 경계값 보강
	...
	- 수용 기준: 기존 테스트 유지. (메시지 스타일 소문자 시작·마침표 없음으로 통일)
